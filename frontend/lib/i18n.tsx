...
const EN: Translations = {
  ...
  'clientDash.subtitle':          'Manage and upload your tax documents',
  ...
  'clientDash.noPreviousYears':   'No previous years on file.',
  'clientDash.noYears':           'No tax years found.',
  'clientDash.changePassword':    'Change password',
  'clientDash.progress':          'Completeness',
  'clientDash.noDocuments':       'No documents uploaded yet.',
  'clientDash.startUploading':    'Start uploading',
  'clientDash.viewUpload':        'View & upload',
  'clientDash.current':           'Current year',
  'clientDash.completed':         'Your',
  'clientDash.completeSingle':    'tax return is complete!',
  'clientDash.completeMulti':     'tax returns are complete!',
  'clientDash.processingComplete':'Your accountant has finished processing your file.',
  'clientDash.actionRequired':    'Action required',
  ...
  'acctClient.returnComplete':   '✅ File Completed',
  'acctClient.reopen':           '↩ Re-open',
  'acctClient.reopening':        'Reopening…',
  'acctClient.approve':          'Approve',
  'acctClient.approved':         'approved',
  'acctClient.pending':          'pending',
  'acctClient.reject':           'Reject',
  'acctClient.rejectionReason':  'Rejection reason (shown to client)',
  'acctClient.rejectBtn':        'Reject Document',
  'acctClient.confirmReject':    'Confirm rejection',
  'acctClient.clientWillSee':    'The client will see this message.',
  'acctClient.documents':        'Documents',
  'acctClient.noDocuments':      'No documents uploaded yet.',
  'acctClient.noDocsUploaded':   'No documents uploaded',
  'acctClient.cannotComplete':   'Cannot complete — resolve document issues first',
  'acctClient.view':             '👁 View',
  'acctClient.reset':            '↩ Reset',
  'acctClient.rescan':           '🔄 Re-scan',
  'acctClient.internalNotes':    'Internal Notes',
  'acctClient.notesHint':        'Only visible to you — not shown to the client.',
  'acctClient.notesSaved':       '✓ Saved',
  'acctClient.saveNotes':        'Save Notes',
  'acctClient.saving':           'Saving…',
  'acctClient.validations':      'Validation Checks',
  'acctClient.needAttention':    'need attention',
  'acctClient.rejected':         '✗ Rejected:',
  'acctClient.couldNotOpen':     'Could not open document',
  'acctClient.complete':         '✅ Tax year marked as complete!',
  ...
  'billing.subtitle':         'Manage your TaxFlowAI subscription',
  'billing.backToDash':       'Back to Dashboard',
  ...
  'billing.trialEnds':        'Your free trial ends on',
  'billing.trialEndsSub':     'Subscribe before then to keep access.',
  'billing.nextBilling':      'Next billing date:',
  'billing.pastDueMsg':       'Your payment is past due. Update your payment method to avoid service interruption.',
  'billing.inactiveMsg':      'Your subscription is inactive. Subscribe to add new clients.',
  'billing.activeClients':    'Active Clients',
  'billing.billedFor':        'Billed for',
  'billing.clientsX12':       'clients × 12$ =',
  'billing.minYear':          '(minimum 500$/year)',
  'billing.plan':             'Professional Plan',
  'billing.planSubtitle':     'Billed annually — no monthly surprises',
  'billing.onboarding':       'One-time onboarding fee',
  'billing.onboardingDesc':   'Setup, integration & going live',
  'billing.features.unlimited':     'Unlimited document uploads per client',
  'billing.features.ai':            'AI-powered completeness validation',
  'billing.features.notifications': 'Email notifications & daily digest',
  'billing.features.portal':        'Client portal with secure access',
  'billing.features.support':       'Priority support',
  'billing.subscribe':        'Subscribe Now',
  'billing.manage':           'Manage Subscription',
  'billing.redirecting':      'Redirecting…',
  'billing.footer':           'Payments are processed securely by Stripe. TaxFlowAI does not store card details.',
  'billing.successMsg':       '🎉 Subscription activated! Welcome aboard.',
  'billing.canceledMsg':      'Checkout was canceled. No charge was made.',
};
...
const FR: Translations = {
  ...
  'clientDash.subtitle':          'Gérez et téléversez vos documents fiscaux',
  ...
  'clientDash.noPreviousYears':   'Aucune année précédente au dossier.',
  'clientDash.noYears':           'Aucune année fiscale trouvée.',
  'clientDash.changePassword':    'Changer le mot de passe',
  'clientDash.progress':          'Complétude',
  'clientDash.noDocuments':       'Aucun document téléversé.',
  'clientDash.startUploading':    'Commencer le téléversement',
  'clientDash.viewUpload':        'Voir & téléverser',
  'clientDash.current':           'Année courante',
  'clientDash.completed':         'Votre déclaration',
  'clientDash.completeSingle':    'est complète!',
  'clientDash.completeMulti':     'sont complètes!',
  'clientDash.processingComplete':'Votre comptable a terminé le traitement de votre dossier.',
  'clientDash.actionRequired':    'Action requise',
  ...
  'acctClient.returnComplete':   '✅ Dossier complété',
  'acctClient.reopen':           '↩ Réouvrir',
  'acctClient.reopening':        'Réouverture…',
  'acctClient.approve':          'Approuver',
  'acctClient.approved':         'approuvé(s)',
  'acctClient.pending':          'en attente',
  ...
  'acctClient.confirmReject':    'Confirmer le rejet',
  'acctClient.clientWillSee':    'Le client verra ce message.',
  'acctClient.documents':        'Documents',
  'acctClient.noDocuments':      'Aucun document téléversé pour l\'instant.',
  'acctClient.noDocsUploaded':   'Aucun document téléversé',
  'acctClient.cannotComplete':   'Impossible de compléter — résolvez d\'abord les problèmes de documents',
  'acctClient.view':             '👁 Voir',
  'acctClient.reset':            '↩ Réinitialiser',
  'acctClient.rescan':           '🔄 Rescanner',
  'acctClient.internalNotes':    'Notes internes',
  'acctClient.notesHint':        'Visible uniquement par vous — non affiché au client.',
  'acctClient.notesSaved':       '✓ Enregistré',
  'acctClient.saveNotes':        'Enregistrer les notes',
  'acctClient.saving':           'Enregistrement…',
  'acctClient.validations':      'Vérifications de validation',
  'acctClient.needAttention':    'nécessitent attention',
  'acctClient.rejected':         '✗ Rejeté :',
  'acctClient.couldNotOpen':     'Impossible d\'ouvrir le document',
  'acctClient.complete':         '✅ Année fiscale marquée comme complète!',
  ...
  'billing.subtitle':         'Gérez votre abonnement TaxFlowAI',
  'billing.backToDash':       'Retour au tableau de bord',
  ...
  'billing.trialEnds':        'Votre essai gratuit se termine le',
  'billing.trialEndsSub':     "Abonnez-vous avant cette date pour conserver l'accès.",
  'billing.nextBilling':      'Prochaine facturation :',
  'billing.pastDueMsg':       "Votre paiement est en retard. Mettez à jour votre mode de paiement pour éviter une interruption de service.",
  'billing.inactiveMsg':      "Votre abonnement est inactif. Abonnez-vous pour ajouter de nouveaux clients.",
  'billing.activeClients':    'Clients actifs',
  'billing.billedFor':        'Facturé pour',
  'billing.clientsX12':       'clients × 12$ =',
  'billing.minYear':          '(minimum 500$/an)',
  'billing.plan':             'Plan professionnel',
  'billing.planSubtitle':     'Facturé annuellement — sans surprise mensuelle',
  'billing.onboarding':       "Frais d'intégration uniques",
  'billing.onboardingDesc':   'Configuration, intégration et mise en ligne',
  'billing.features.unlimited':     'Téléversements de documents illimités par client',
  'billing.features.ai':            'Validation de complétude par intelligence artificielle',
  'billing.features.notifications': 'Notifications par courriel et résumé quotidien',
  'billing.features.portal':        'Portail client avec accès sécurisé',
  'billing.features.support':       'Support prioritaire',
  'billing.subscribe':        "S'abonner",
  'billing.manage':           "Gérer l'abonnement",
  'billing.redirecting':      'Redirection…',
  'billing.footer':           'Les paiements sont traités de façon sécurisée par Stripe. TaxFlowAI ne conserve pas vos informations de carte.',
  'billing.successMsg':       '🎉 Abonnement activé ! Bienvenue.',
  'billing.canceledMsg':      "Le paiement a été annulé. Aucun frais n'a été facturé.",
};
